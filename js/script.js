$(document).ready(function () {
  $("button.btn").click(function (event) {
    ...
    if (pizzaNew.topping == "pepperoni" || pizzaNew.topping == "mushroom") {
      ...
      pizzaNew.topping == "fresh garlic" ||
      pizzaNew.topping == "onion"
    ) {
      toppingPrice += 50;
    }
    ...
    if (
      pizzaNew.flavour == "Chicken pizza" ||
      pizzaNew.flavour == "marc&cheese"
    ) {
      flavourPrice += 200;
    } else if (
      pizzaNew.flavour == "fruity pizza" ||
      pizzaNew.flavour == "raspberry pizza"
    ) {
      flavourPrice += 100;
    }
    if (locationn == "") {
